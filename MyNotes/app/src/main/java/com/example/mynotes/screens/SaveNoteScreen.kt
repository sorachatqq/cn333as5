        ...
        actions = {
            ...
            IconButton(onClick = onOpenColorPickerClick) {
                Icon(
                    ...
                    contentDescription = "Open Type Button",
                    tint = MaterialTheme.colors.onPrimary
                )
            }
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ContentTextField(
            ...
            onTextChange = { newTitle ->
                onNoteChange.invoke(note.copy(name = newTitle))
            }
        )
        ...
        val isChecked: Boolean = note.isFavorite
        ...
        FavoriteCheckOption(
            ...
            onCheckedChange = { FavoriteNewValue ->
                ...
                onNoteChange.invoke(note.copy(isFavorite = isCheckedOff))
            }
        )
